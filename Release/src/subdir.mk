...
src/%.o: ../src/%.cpp src/subdir.mk
	...
	g++ -I"/home/student/eclipse-workspace/as4/inc" -I/usr/local/include/OGRE -I/usr/local/include/OGRE/Overlay -I/usr/include/ois -O3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
